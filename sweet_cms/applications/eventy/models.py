...
class ProgrammeFile(PkModel):
    ...
    # file_status = Column(db.String(80), server_default=db.text('in queue'), default='in queue', nullable=False)
    file_status = Column(db.String(80), default='in queue', server_default='in queue', nullable=False)
